export type CheckKey = "name_match" | "date_of_birth" | "date_of_exit" | "bank_account";
...
// per-user data. This is what keeps the whole explanation space to ~9-11
...
export type ExplainVariant =
  ...
  | "dob_minor_drift" // date_of_birth warn: within the 3-year Aadhaar tolerance
  | "dob_major_drift" // date_of_birth fail: beyond it, needs documentary proof
