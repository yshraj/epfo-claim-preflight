        ...
        <Reveal>
          <div className="relative z-10">
            ...
            <h2 className="mt-4 font-display font-medium text-2xl sm:text-3xl text-slate-800">
              A guided EPFO experience that catches problems before submission.
            </h2>
          ...
          <div className="relative max-w-sm mx-auto md:mx-0 md:ml-auto w-full">
            <div className="bg-white border border-slate-200/60 shadow-xl rounded-2xl overflow-hidden">
              <div className="bg-slate-50 border-b border-slate-200/60 px-6 py-5 flex items-center justify-between">
                <div className="font-medium text-slate-700">Claim Readiness</div>
                <div className="text-2xl font-bold font-display text-amber-600">86%</div>
              </div>
              <div className="p-6 space-y-4">
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-3 text-slate-700"><div className="h-5 w-5 rounded-full bg-emerald-100 flex items-center justify-center"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-emerald-600"><path d="M20 6L9 17l-5-5"/></svg></div> Identity</div>
                  <span className="text-slate-400 font-mono text-xs">Verified</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-3 text-slate-700"><div className="h-5 w-5 rounded-full bg-emerald-100 flex items-center justify-center"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-emerald-600"><path d="M20 6L9 17l-5-5"/></svg></div> KYC</div>
                  <span className="text-slate-400 font-mono text-xs">Verified</span>
                </div>
                <div className="flex items-center justify-between text-sm bg-amber-50 -mx-6 px-6 py-2 border-y border-amber-100/50">
                  <div className="flex items-center gap-3 text-amber-900 font-medium"><div className="h-5 w-5 rounded-full bg-amber-200 flex items-center justify-center"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-amber-700"><path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg></div> Name consistency</div>
                  <span className="text-amber-600 font-mono text-xs font-medium">Mismatch</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-3 text-slate-700"><div className="h-5 w-5 rounded-full bg-emerald-100 flex items-center justify-center"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-emerald-600"><path d="M20 6L9 17l-5-5"/></svg></div> Bank</div>
                  <span className="text-slate-400 font-mono text-xs">Active</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-3 text-slate-700"><div className="h-5 w-5 rounded-full bg-emerald-100 flex items-center justify-center"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-emerald-600"><path d="M20 6L9 17l-5-5"/></svg></div> Employment</div>
                  <span className="text-slate-400 font-mono text-xs">Verified</span>
                </div>
              </div>
            </div>
